...
public class RSAUtils {
	...
	public static KeyPair generateKeyPair() throws Exception {
		try {
			...
			log.info("private:{}, public:{}", keyPair.getPrivate(), keyPair.getPublic());
			KEY_PAIR = keyPair;
			return keyPair;
		} catch (Exception e) {
	...
	public static String getModulus() {
		BigInteger b = ((JCERSAPrivateKey) KEY_PAIR.getPrivate()).getModulus();
		return b.toString(16);
	}
